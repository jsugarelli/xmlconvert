...
In this case, we use `fields = "attributes"` instead of `fields = "tags"` to adjust to this XML data structure. Here, a call of `xml_to_df()` could look like this:
...
GitHub: [https://github.com/jsugarelli/xmlconvert](https://github.com/jsugarelli/xmlconvert)
